 ...
 * utiliza callback do Flyway rodando após migrações
 * 
 */
...
insert into cozinha (id, nome) values (5, 'Coreana');
...
insert into forma_pagamento (id, descricao, data_atualizacao) values (4, 'Pix', utc_timestamp);
...
insert into produto (nome, descricao, preco, ativo, restaurante_id) values ('Macarrão a Moda da Casa', 'Deliciosa massa ao molho especial', 18.90, 1, 1);
...
(1, 'João da Silva', 'wbaamaral+joao.ger@gmail.com', '123', utc_timestamp),
(2, 'Maria Joaquina', 'wbaamaral+maria.vnd@gmail.com', '123', utc_timestamp),
(3, 'José Souza', 'wbaamaral+jose.aux@gmail.com', '123', utc_timestamp),
(4, 'Sebastião Martins', 'wbaamaral+sebastiao.cad@gmail.com', '123', utc_timestamp),
(5, 'Manoel Lima', 'wbaamaral+manoel.loja@gmail.com', '123', utc_timestamp),
(6, 'Débora Mendonça', 'wbaamaral+debora@gmail.com', '123', utc_timestamp),
(7, 'Carlos Lima', 'wbaamaral+carlos@gmail.com', '123', utc_timestamp);      
