...
public class CadastroCozinhaService {
	...
	private static final String MSG_COZINHA_NAO_PODE_SER_REMOVIDA = "Cozinha de código %d não pode ser removida, pois está em uso";
	...
	public Cozinha buscarOuFalhar(Long cozinhaId) {
		return cozinhaRepository.findById(cozinhaId).orElseThrow(
				() -> new EntidadeNaoEncontradaException(String.format(MSG_COZINHA_EM_USO, cozinhaId)));
	}
}
